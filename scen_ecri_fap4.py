...
class Scenarii(App):
    ...
    def build(self):
        ...
        if (self.status) != (get_message(self.ScmParam, 'TOURNANT')):
            ...
            layout_current7.add_widget(MyLabel(text=get_message(self.ScmParam, 'Informations'), size_hint=(1, None), bgcolor=(1, 0, 0, 0.3)))
        ...
        root.add_widget(MyButton(text=get_message_by_id('1053'), on_press=self.finish, font_size=fs*1.5))
        return root
    ...
    def regen(self):
        ...
        root.height += par1.height + par2.height + par3.height + par4.height + par5.height + par6.height + par8.height + par9.height + par10.height + par11.height
        self.button_stop = MyButton(text=get_message(self.ScmParam, '69')+str(' ')+get_message(self.ScmParam, 'SCMTitle'), on_press=self.stop_regen)
        roo = ScrollView(size_hint=(1, 1))
        roo.add_widget(root)
        layout.add_widget(roo)
        layout.add_widget(self.button_stop)
        return layout
    ...
    def stop_regen(self, instance=None):
        ...
        layout_popup.add_widget(MyButton(text=get_message_by_id('1053'), on_press=self.finish, size_hint=(1, 0.2)))

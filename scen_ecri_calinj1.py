...
class Scenarii(App):
    ...
    def build(self):
        ...
        root.add_widget(MyLabel(text=header, height=fs * 2))
        root.add_widget(MyLabel(text=self.get_message('TexteTitre'), height=fs * 2, bgcolor=(1, 1, 0, 0.3)))
        ...
        root.add_widget(MyLabel(text=pyren_encode(label1), height=fs * 2, size_hint=(1, None), font_size=fs * 1.5, bgcolor=(0, 1, 1, 0.3)))
        layout_current1 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_current1.add_widget(MyLabel(text=self.get_message('dat_TitreActuel'), height=fs * 2, size_hint=(0.6, None), bgcolor=(0, 0, 1, 0.3)))
        layout_current1.add_widget(MyLabel(text=values1, size_hint=(0.4, None), height=fs * 2, bgcolor=(0, 1, 0, 0.3)))
        layout_c1 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_c1.add_widget(MyLabel(text=self.get_message('dat_TitreSouhaite'), height=fs * 2, size_hint=(0.6, None), bgcolor=(1, 0, 0, 0.3)))
        self.injec1 = TextInput(text=notv, height=fs*2, multiline=False, size_hint=(0.4, None), halign = 'center', font_size=fs)
        ...
        root.add_widget(MyLabel(text=pyren_encode(label2), height=fs * 2, size_hint=(1, None), font_size=fs * 1.5, bgcolor=(0, 1, 1, 0.3)))
        layout_current2 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_current2.add_widget(MyLabel(text=self.get_message('dat_TitreActuel'), height=fs * 2, size_hint=(0.6, None), bgcolor=(0, 0, 1, 0.3)))
        layout_current2.add_widget(MyLabel(text=values2, height=fs * 2, size_hint=(0.4, None), bgcolor=(0, 1, 0, 0.3)))
        layout_c2 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_c2.add_widget(MyLabel(text=self.get_message('dat_TitreSouhaite'), height=fs * 2, size_hint=(0.6, None), bgcolor=(1, 0, 0, 0.3)))
        self.injec2 = TextInput(text=notv, height=fs*2, multiline=False, size_hint=(0.4, None), halign = 'center', font_size=fs)
        ...
        root.add_widget(MyLabel(text=pyren_encode(label3), height=fs * 2, size_hint=(1, None), font_size=fs * 1.5, bgcolor=(0, 1, 1, 0.3)))
        layout_current3 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_current3.add_widget(MyLabel(text=self.get_message('dat_TitreActuel'), height=fs * 2, size_hint=(0.6, None), bgcolor=(0, 0, 1, 0.3)))
        layout_current3.add_widget(MyLabel(text=values3, height=fs * 2, size_hint=(0.4, None), bgcolor=(0, 1, 0, 0.3)))
        layout_c3 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_c3.add_widget(MyLabel(text=self.get_message('dat_TitreSouhaite'), height=fs * 2, size_hint=(0.6, None), bgcolor=(1, 0, 0, 0.3)))
        self.injec3 = TextInput(text=notv, height=fs*2, multiline=False, size_hint=(0.4, None), halign = 'center', font_size=fs)
        ...
        root.add_widget(MyLabel(text=pyren_encode(label4), size_hint=(1, None), height=fs * 2, font_size=fs * 1.5, bgcolor=(0, 1, 1, 0.3)))
        layout_current4 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_current4.add_widget(MyLabel(text=self.get_message('dat_TitreActuel'), height=fs * 2, size_hint=(0.6, None), bgcolor=(0, 0, 1, 0.3)))
        layout_current4.add_widget(MyLabel(text=values4, size_hint=(0.4, None), height=fs * 2, bgcolor=(0, 1, 0, 0.3)))
        layout_c4 = BoxLayout(orientation='horizontal', height=fs * 2, size_hint=(1, None))
        layout_c4.add_widget(MyLabel(text=self.get_message('dat_TitreSouhaite'), height=fs * 2, size_hint=(0.6, None), bgcolor=(1, 0, 0, 0.3)))
        self.injec4 = TextInput(text=notv, height=fs*2, multiline=False, size_hint=(0.4, None), halign = 'center', font_size=fs)
        ...
        root.add_widget(MyButton(text=self.get_message('TexteTitre'), on_press=self.write_inj, size_hint=(1, None), height=80))
        root.add_widget(MyButton(text=self.get_message('6218'), on_press=self.stop, size_hint=(1, None), height=80))

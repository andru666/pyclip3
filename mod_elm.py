...
class ELM:    
    ...
    def __init__(self, portName, speed, log, startSession='10C0'):
        ...
        if mod_globals.opt_lang == 'RU':
            negrsp = {"10": "NR: Общий Отказ",
                      "13": "NR: Неверная Длина Сообщения Или Недопустимый Формат",
                      "21": "NR: Повторный Запрос Занят",
                      "22": "NR: Неверные Условия Или Ошибка Последовательности Запросов",
                      "23": "NR: Процедура Не завершена",
                      "24": "NR: Ошибка Последовательности Запросов",
                      "31": "NR: Запрос Выходит За пределы Диапазона",
                      "33": "NR: Отказано в доступе по системе безопасности - Запрошен доступ по системе безопасности ",
                      "36": "NR: Превышено Количество Попыток",
                      "37": "NR: Требуемое Время Задержки Не Истекло",
                      "40": "NR: Загрузка не принята",
                      "41": "NR: Неправильный тип загрузки",
                      "42": "NR: Невозможно загрузить на указанный адрес",
                      "43": "NR: Не удается загрузить запрошенное количество байт",
                      "50": "NR: Загрузка не принята",
                      "51": "NR: Неправильный тип загрузки",
                      "52": "NR: Не удается загрузить с указанного адреса",
                      "53": "NR: Не удается загрузить запрошенное количество байт",
                      "70": "NR: Загрузка не принята",
                      "71": "NR: Передача Данных приостановлена",
                      "72": "NR: Общий Сбой Программирования",
                      "73": "NR: Неверный Счетчик Последовательности Блоков",
                      "74": "NR: Недопустимый Адрес При Передаче Блока",
                      "75": "NR: Недопустимый Байт Количество При Передаче блока",
                      "76": "NR: Недопустимый тип Передачи Блока",
                      "77": "NR: Ошибка Контрольной Суммы Данных При Передаче Блока",
                      "78": "NR: Запрос Получен Правильно - Ответ Ожидает",
                      "79": "NR: Неверное количество байтов При Передаче Блока",
                      "7E": "NR: Подфункция Не Поддерживается В Активном Сеансе",
                      "7F": "NR: Служба Не Поддерживается В Активном Сеансе",
                      "81": "NR: Слишком Высокие Обороты",
                      "82": "NR: Слишком Низкие Обороты",
                      "85": "NR: Слишком низкая частота вращения двигателя",
                      "86": "NR: Температура слишком высокая",
                      "87": "NR: Температура слишком низкая",
                      "89": "NR: Слишком низкая скорость автомобиля",
                      "8A": "NR: Слишком высокая скорость дроссельной заслонки/педали газа",
                      "8B": "NR: Дроссель/Педаль газа Слишком низко опущены",
                      "8C": "NR: Диапазон передачи на нейтральной передаче",
                      "8D": "NR: Диапазон передачи на полной передаче",
                      "8F": "NR: Переключатель (ы) тормоза не закрыт (педаль тормоза не нажата или не применяется)",
                      "90": "NR: Рычаг Переключения Передач не установлен",
                      "91": "NR: Сцепление Гидротрансформатора заблокировано"}
        negrsp1 = {"11": "NR: " + mod_globals.language_dict['24749'],
                       "12": "NR: " + mod_globals.language_dict['885'],
                       "35": "NR: " + mod_globals.language_dict['24754'],
                       "80": "NR: " + mod_globals.language_dict['516'],
                       "83": "NR: " + mod_globals.language_dict['11756'],
                       "84": "NR: " + mod_globals.language_dict['60649'],
                       "88": "NR: " + mod_globals.language_dict['23393'],
                       "92": "NR: " + mod_globals.language_dict['19690'],
                       "93": "NR: " + mod_globals.language_dict['19689']
                      }
        negrsp.update(negrsp1)

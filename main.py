        ...
        if not mod_globals.opt_port and not mod_globals.opt_demo:
            ...
            if mod_globals.opt_lang == 'RU':
                negrsp = {"10": "NR: Общий Отказ",
                          "12": "NR: Подфункция Не Поддерживается",
                          ...
                          "80": "NR: Служба Не Поддерживается В Режиме Активной Диагностики",
                          "81": "NR: Слишком Высокие Обороты",
                          "82": "NR: Слишком Низкие Обороты",
                          "83": "NR: Двигатель работает",
                          "84": "NR: Двигатель не работает",
                          "85": "NR: Время работы двигателя истекло",
                          "86": "NR: Температура слишком высокая",
                          "87": "NR: Температура слишком низкая",
                          "88": "NR: Слишком высокая скорость автомобиля",
